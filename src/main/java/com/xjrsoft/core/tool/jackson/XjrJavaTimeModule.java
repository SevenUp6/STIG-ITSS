package com.xjrsoft.core.tool.jackson;
...
import com.xjrsoft.core.tool.utils.DateTimeUtil;

import java.time.LocalDate;
import java.time.LocalDateTime;
import java.time.LocalTime;

public class XjrJavaTimeModule extends SimpleModule {
    public XjrJavaTimeModule() {
