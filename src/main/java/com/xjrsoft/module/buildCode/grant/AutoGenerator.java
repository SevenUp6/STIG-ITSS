...
import com.xjrsoft.module.buildCode.engine.VelocityTemplateEngine;
...
public class AutoGenerator {
    ...
    public void execute() {
        ...
        if (null == config) {
            ...
            } else if (CollectionUtil.isNotEmpty(tableInfoList)) {
                config = new ConfigBuilder(packageInfo, tableInfoList, strategy, template, globalConfig);
            }
