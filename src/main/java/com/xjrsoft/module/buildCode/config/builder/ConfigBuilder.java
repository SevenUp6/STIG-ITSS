package com.xjrsoft.module.buildCode.config.builder;
...
public class ConfigBuilder {
    ...
    public ConfigBuilder(PackageConfig packageConfig, List<TableInfo> tableInfoList, StrategyConfig strategyConfig,
                         TemplateConfig template, GlobalConfig globalConfig) {
        // 全局配置
        this.globalConfig = Optional.ofNullable(globalConfig).orElseGet(GlobalConfig::new);
        // 模板配置
        ...
        handlerStrategy(this.strategyConfig, tableInfoList);
    }
    ...
    private void handlerStrategy(StrategyConfig config, List<TableInfo> tableInfoList) {
        processTypes(config);
        this.tableInfoList = processTable(tableInfoList, config);
    }
